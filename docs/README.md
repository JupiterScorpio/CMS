...
**CMS is an ASP.NET MVC 5 C# open source content management framework**

CMS wraps up a lot of the time consuming aspects of website creation. CMS is a framework for developers create bespoke website whilst at the same time giving content editors an easy to use CMS.

## Apps
Apps in CMS contain all the functionality your website requires. For example, you might want a Blog App which contains page definitions for a list of blogs and a blog page itself. 

CMS comes with 3 basic apps, 'Core', 'Articles' and 'Galleries'. The CoreApp contains basic concepts such as login and registration. It also has some basic page types such as 'TextPage' which can be used as a base page type for other pages.

Ultimately though, you can throw these three apps out and start building your own if you want.

### Creating your first CMS App
...
This registers your App with CMS. Note that your App definition must inherit from MrCMSApp.
...
Note in this instance we are inheriting from Webpage. This tells CMS that this page can be added to the CMS. Webpage has a lot of properties which are shared across all webpages, such as Page Tile and Meta Description. It also has BodyContent for the main body of text of any webpage.
...
This is the page CMS uses to edit your custom page fields.

At this point you now have a new page type which can be added to CMS. You can have a lot more control over your pages and how they act by using DocumentMetadataMap<> - this class allows you to specify page behaviour, for example if you have custom Controller you'd like to use rather than the standard CMS one you can specify that here.

The CMS ECommerce App listed  has a lot more functionality to it that just a simple page, so if you'd like to see how more complicated apps are built check this project out.
...
*   The CMS admin logo can now be swapped out through System Settings - Site Settings
